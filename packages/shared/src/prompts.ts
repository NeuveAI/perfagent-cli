...
export const buildLocalAgentSystemPrompt = (): string =>
  [
    ...
    "",
    "<tool_catalog>",
    "Dispatchers (toolName, then `args.command`):",
    "- interact — mutate page state: navigate, click, type, fill, press_key, hover, drag, fill_form, upload_file, handle_dialog, wait_for, resize, new_tab, switch_tab, close_tab.",
    "- observe — read page state: snapshot, screenshot, console, network, pages, evaluate.",
    "- trace — profile perf: start, stop, analyze, memory, lighthouse, emulate.",
