...
_Generated 2026-05-02T10:54:12.183Z from `evals/traces/wave-harness-r2-plan-update` (60/80 traces present)._
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| gemma-react | 20 | 4 | 5 | 11 | 0.348 | 0.100 | 0.000 | 0.392 | 73345 | 13101 | 9.4 | 0.0 |
| gemini-react | 20 | 6 | 14 | 0 | 0.423 | 0.150 | 0.000 | 0.436 | 217678 | 37239 | 8.5 | 0.0 |
| gemma-oracle-plan | 20 | 0 | 0 | 20 | 0.348 | 0.000 | 0.000 | 0.392 | 73195 | 13325 | 9.7 | 0.0 |
...
| calibration-2-single-nav-news | INCOMPLETE  cov=1.00  pu=0  turns=5 | OK  cov=1.00  pu=0  turns=5 | INCOMPLETE  cov=1.00  pu=0  turns=5 | — |
| calibration-3-two-step-docs | OK  cov=0.50  pu=0  turns=10 | OK  cov=0.50  pu=0  turns=4 | INCOMPLETE  cov=0.50  pu=0  turns=10 | — |
| calibration-4-two-step-ecom | FAIL  cov=0.00  pu=0  turns=7 | FAIL  cov=0.00  pu=0  turns=4 | INCOMPLETE  cov=0.00  pu=0  turns=7 | — |
| calibration-5-three-step-search | INCOMPLETE  cov=0.33  pu=0  turns=3 | FAIL  cov=0.33  pu=0  turns=6 | INCOMPLETE  cov=0.33  pu=0  turns=15 | — |
| hard-volvo-ex90-configurator | FAIL  cov=0.00  pu=0  turns=7 | FAIL  cov=0.00  pu=0  turns=3 | INCOMPLETE  cov=0.00  pu=0  turns=7 | — |
| journey-1-car-configurator-bmw | INCOMPLETE  cov=0.00  pu=0  turns=5 | FAIL  cov=0.00  pu=0  turns=15 | INCOMPLETE  cov=0.00  pu=0  turns=5 | — |
| journey-2-ecom-checkout | INCOMPLETE  cov=0.00  pu=0  turns=15 | FAIL  cov=0.40  pu=0  turns=15 | INCOMPLETE  cov=0.00  pu=0  turns=15 | — |
...
| journey-5-insurance-quote | FAIL  cov=0.00  pu=0  turns=13 | FAIL  cov=0.25  pu=0  turns=10 | INCOMPLETE  cov=0.00  pu=0  turns=12 | — |
| journey-6-media-streaming | INCOMPLETE  cov=0.80  pu=0  turns=15 | FAIL  cov=1.00  pu=0  turns=15 | INCOMPLETE  cov=0.80  pu=0  turns=9 | — |
| journey-7-dashboard-filter | INCOMPLETE  cov=0.25  pu=0  turns=12 | FAIL  cov=0.75  pu=0  turns=15 | INCOMPLETE  cov=0.25  pu=0  turns=12 | — |
| journey-8-help-center | INCOMPLETE  cov=0.25  pu=0  turns=15 | FAIL  cov=1.00  pu=0  turns=15 | INCOMPLETE  cov=0.25  pu=0  turns=15 | — |
| journey-9-form-wizard | FAIL  cov=0.00  pu=0  turns=6 | FAIL  cov=0.20  pu=0  turns=11 | INCOMPLETE  cov=0.00  pu=0  turns=6 | — |
| journey-10-marketplace-filter | FAIL  cov=0.17  pu=0  turns=8 | FAIL  cov=0.17  pu=0  turns=3 | INCOMPLETE  cov=0.17  pu=0  turns=8 | — |
| moderate-1-github-explore-topics | INCOMPLETE  cov=0.33  pu=0  turns=15 | OK  cov=0.33  pu=0  turns=8 | INCOMPLETE  cov=0.33  pu=0  turns=15 | — |
| moderate-2-mdn-web-api-detail | INCOMPLETE  cov=0.33  pu=0  turns=6 | FAIL  cov=0.33  pu=0  turns=8 | INCOMPLETE  cov=0.33  pu=0  turns=7 | — |
| trivial-1-example-homepage | OK  cov=1.00  pu=0  turns=6 | OK  cov=1.00  pu=0  turns=5 | INCOMPLETE  cov=1.00  pu=0  turns=6 | — |
| trivial-2-wikipedia-main-page | OK  cov=1.00  pu=0  turns=6 | OK  cov=0.00  pu=0  turns=3 | INCOMPLETE  cov=1.00  pu=0  turns=6 | — |
