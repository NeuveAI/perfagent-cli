...
_Generated 2026-04-30T10:05:27.871Z from `evals/traces/wave-r9-prompt-aligned` (20/60 traces present)._
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| gemma-react | 20 | 3 | 2 | 15 | 0.314 | 0.050 | 0.025 | 0.314 | 90225 | 14285 | 10.3 | 0.0 |
...
| calibration-2-single-nav-news | INCOMPLETE  cov=1.00  pu=0  turns=9 | — | — |
| calibration-3-two-step-docs | OK  cov=0.50  pu=0  turns=8 | — | — |
| calibration-4-two-step-ecom | INCOMPLETE  cov=0.00  pu=0  turns=6 | — | — |
| calibration-5-three-step-search | INCOMPLETE  cov=0.33  pu=0  turns=7 | — | — |
| hard-volvo-ex90-configurator | INCOMPLETE  cov=0.00  pu=0  turns=11 | — | — |
| journey-1-car-configurator-bmw | INCOMPLETE  cov=0.00  pu=0  turns=7 | — | — |
| journey-2-ecom-checkout | INCOMPLETE  cov=0.20  pu=0  turns=15 | — | — |
| journey-3-flight-search | INCOMPLETE  cov=0.25  pu=0  turns=12 | — | — |
| journey-4-account-signup | INCOMPLETE  cov=0.00  pu=0  turns=15 | — | — |
| journey-5-insurance-quote | FAIL  cov=0.00  pu=0  turns=14 | — | — |
| journey-6-media-streaming | INCOMPLETE  cov=0.00  pu=0  turns=11 | — | — |
| journey-7-dashboard-filter | INCOMPLETE  cov=0.25  pu=0  turns=11 | — | — |
| journey-8-help-center | INCOMPLETE  cov=0.25  pu=0  turns=15 | — | — |
| journey-9-form-wizard | INCOMPLETE  cov=0.00  pu=0  turns=15 | — | — |
| journey-10-marketplace-filter | FAIL  cov=0.17  pu=0  turns=6 | — | — |
| moderate-1-github-explore-topics | INCOMPLETE  cov=0.33  pu=0  turns=15 | — | — |
| moderate-2-mdn-web-api-detail | INCOMPLETE  cov=0.00  pu=0  turns=15 | — | — |
...
| moderate-2-mdn-web-api-detail | toolCallValidity | 0.500 | 0.000 | -0.500 | left-better |
