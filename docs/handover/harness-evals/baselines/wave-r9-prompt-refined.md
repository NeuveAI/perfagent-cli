...
_Generated 2026-04-30T10:29:56.277Z from `evals/traces/wave-r9-prompt-refined` (20/60 traces present)._
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| gemma-react | 20 | 3 | 2 | 15 | 0.379 | 0.100 | 0.000 | 0.464 | 21354 | 5632 | 6.3 | 0.0 |
...
| calibration-2-single-nav-news | INCOMPLETE  cov=1.00  pu=0  turns=5 | — | — |
| calibration-3-two-step-docs | INCOMPLETE  cov=0.50  pu=0  turns=5 | — | — |
| calibration-4-two-step-ecom | FAIL  cov=0.00  pu=0  turns=7 | — | — |
| calibration-5-three-step-search | INCOMPLETE  cov=0.33  pu=0  turns=5 | — | — |
| hard-volvo-ex90-configurator | INCOMPLETE  cov=0.17  pu=0  turns=15 | — | — |
| journey-1-car-configurator-bmw | INCOMPLETE  cov=0.00  pu=0  turns=5 | — | — |
| journey-2-ecom-checkout | INCOMPLETE  cov=0.00  pu=0  turns=7 | — | — |
| journey-3-flight-search | INCOMPLETE  cov=0.00  pu=0  turns=3 | — | — |
| journey-4-account-signup | INCOMPLETE  cov=0.20  pu=0  turns=13 | — | — |
| journey-5-insurance-quote | INCOMPLETE  cov=0.25  pu=0  turns=3 | — | — |
| journey-6-media-streaming | INCOMPLETE  cov=0.80  pu=0  turns=8 | — | — |
| journey-7-dashboard-filter | INCOMPLETE  cov=0.25  pu=0  turns=5 | — | — |
| journey-8-help-center | INCOMPLETE  cov=0.25  pu=0  turns=7 | — | — |
| journey-9-form-wizard | INCOMPLETE  cov=0.00  pu=0  turns=9 | — | — |
| journey-10-marketplace-filter | FAIL  cov=0.17  pu=0  turns=8 | — | — |
