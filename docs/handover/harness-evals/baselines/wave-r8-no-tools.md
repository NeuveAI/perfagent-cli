...
_Generated 2026-04-30T00:03:27.730Z from `evals/traces/wave-r8-no-tools` (20/60 traces present)._
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| gemma-react | 20 | 4 | 0 | 16 | 0.423 | 0.150 | 0.000 | 0.483 | 62646 | 8923 | 8.6 | 0.0 |
...
| calibration-2-single-nav-news | INCOMPLETE  cov=1.00  pu=0  turns=15 | — | — |
| calibration-3-two-step-docs | OK  cov=1.00  pu=0  turns=14 | — | — |
| calibration-4-two-step-ecom | INCOMPLETE  cov=0.00  pu=0  turns=1 | — | — |
| calibration-5-three-step-search | INCOMPLETE  cov=0.33  pu=0  turns=6 | — | — |
| hard-volvo-ex90-configurator | INCOMPLETE  cov=0.00  pu=0  turns=11 | — | — |
| journey-1-car-configurator-bmw | INCOMPLETE  cov=0.00  pu=0  turns=15 | — | — |
| journey-2-ecom-checkout | INCOMPLETE  cov=0.00  pu=0  turns=9 | — | — |
| journey-3-flight-search | INCOMPLETE  cov=0.00  pu=0  turns=3 | — | — |
| journey-4-account-signup | INCOMPLETE  cov=0.20  pu=0  turns=15 | — | — |
| journey-5-insurance-quote | INCOMPLETE  cov=0.00  pu=0  turns=5 | — | — |
| journey-6-media-streaming | INCOMPLETE  cov=1.00  pu=0  turns=15 | — | — |
| journey-7-dashboard-filter | INCOMPLETE  cov=0.25  pu=0  turns=10 | — | — |
| journey-8-help-center | INCOMPLETE  cov=0.25  pu=0  turns=13 | — | — |
| journey-9-form-wizard | INCOMPLETE  cov=0.60  pu=0  turns=15 | — | — |
| journey-10-marketplace-filter | INCOMPLETE  cov=0.17  pu=0  turns=3 | — | — |
| moderate-1-github-explore-topics | INCOMPLETE  cov=0.33  pu=0  turns=3 | — | — |
| moderate-2-mdn-web-api-detail | OK  cov=0.33  pu=0  turns=6 | — | — |
| trivial-1-example-homepage | INCOMPLETE  cov=1.00  pu=0  turns=5 | — | — |
| trivial-2-wikipedia-main-page | OK  cov=1.00  pu=0  turns=4 | — | — |
...
| journey-4-account-signup | stepCoverage | 0.200 | 0.000 | -0.200 | left-better |
| journey-4-account-signup | furthestKeyNode | 0.200 | 0.000 | -0.200 | left-better |
...
| journey-9-form-wizard | stepCoverage | 0.600 | 0.000 | -0.600 | left-better |
| journey-9-form-wizard | furthestKeyNode | 0.800 | 0.000 | -0.800 | left-better |
