...
export const RECENT_REPORTS_VISIBLE_ROWS = 15;
export const RECENT_REPORTS_BRANCH_COLUMN_WIDTH = 20;
export const RECENT_REPORTS_STATUS_COLUMN_WIDTH = 4;
export const RECENT_REPORTS_TIME_COLUMN_WIDTH = 12;
export const RECENT_REPORTS_URL_MIN_WIDTH = 20;
export const RECENT_REPORTS_GUTTER_WIDTH = 3;

export const RELATIVE_TIME_MS_PER_MINUTE = 60 * 1000;
export const RELATIVE_TIME_MS_PER_HOUR = 60 * RELATIVE_TIME_MS_PER_MINUTE;
export const RELATIVE_TIME_MS_PER_DAY = 24 * RELATIVE_TIME_MS_PER_HOUR;
export const RELATIVE_TIME_MS_PER_WEEK = 7 * RELATIVE_TIME_MS_PER_DAY;
...
export const NPM_PACKAGE_NAME = "@neuve/perf-agent-cli";
export const PERF_AGENT_MCP_SERVER_NAME = "perf-agent";
export const CODEX_MCP_STARTUP_TIMEOUT_SEC = 20;
export const VERSION_API_URL = "https://perf-agent.dev/api/version";
